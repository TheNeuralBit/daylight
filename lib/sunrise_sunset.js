// Originally sourced from: http://www.esrl.noaa.gov/gmd/grad/solcalc/main.js
...
function calcHourAngleSunrise(lat, solarDec)
{
  ...
  if (HAarg > 1) return 'NO SUNRISE';
  if (HAarg < -1) return 'NO SUNSET';
...
function calcSunriseSetUTC(rise, JD, latitude, longitude)
{
  ...
  if (hourAngle === 'NO SUNRISE' || hourAngle === 'NO SUNSET')
    return hourAngle;
